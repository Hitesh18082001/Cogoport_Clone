    ...
    return (
        <div className='bottom_main_container'>
            <div className='bottom_left_container'>
                <span className="bottom_copyright_container">© 2023 Cogo Universe PTE. All rights reserved.</span>
                <ul className="bottom_copyright_list">
                    <li role="presentation" class="bottom_list_element">
            ...
            <div className="bottom_language_div1">
                <div>
                    <div >
                        <div role="button" aria-expanded="false">
                            <div role="button" tabindex="0" className="bottom_language_div2">
                                <div className="bottom_language_div3">
                                    <div className='bottom_globe'>
                                        <img alt="IN" loading="lazy" width="20" height="20" decoding="async" data-nimg="1" src="https://www.cogoport.com/_next/image?url=https%3A%2F%2Fcdn.cogoport.io%2Fcms-prod%2Fcogo_public%2Fvault%2Foriginal%2Fglobe.png&w=32&q=75" style={{ color: 'transparent', marginRight: '5px' }} />
                                    </div>
                                    <div class="bottom_language_text">English (IN)</div>
                                </div>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="styles_social_media__kHOsn">
                    <a target="_blank" href="https://in.linkedin.com/company/cogoport" aria-label="linkedin" rel="noreferrer">

                    </a>
                </div>
                <div className="bottom_social_icons">
                    <a target="_blank" href="https://in.linkedin.com/company/cogoport" aria-label="linkedin" rel="noreferrer">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 14 14" width="16" height="16" role="img"><path class="ic-m-linkedin_logo_svg__ic_m_linkedin_logo" d="M2.158 1.038c-.506.112-.92.494-1.089 1.004a1.672 1.672 0 0 0-.002.863c.147.466.501.818.986.983.098.033.198.043.42.043.353.001.544-.052.802-.221a1.45 1.45 0 0 0 .668-1.23c0-.262-.032-.401-.155-.657a1.467 1.467 0 0 0-1.63-.785m7.455 3.755c-.75.134-1.418.542-1.818 1.113l-.118.168V4.993l-1.184.006-1.185.006-.006 3.996-.005 3.996h2.38v-2.234c0-2.379.003-2.467.114-2.789.164-.475.491-.796.937-.917.07-.019.232-.041.36-.048.711-.041 1.167.306 1.369 1.041l.054.198.007 2.375.007 2.374h2.472l-.001-2.608c0-1.617-.009-2.713-.024-2.885-.13-1.476-.878-2.402-2.163-2.675-.294-.062-.94-.082-1.196-.036M1.237 8.995v4.002H3.71V4.993H1.237v4.002" fill-rule="evenodd"></path>
                        </svg>
                    </a>
                    <a target="_blank" href="https://www.facebook.com/Cogoport1" aria-label="facebook" rel="noreferrer">
                    ...
                    <a target="_blank" href="https://www.instagram.com/cogoport" aria-label="instagram" rel="noreferrer">
