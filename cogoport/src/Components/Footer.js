  ...
  return (
    <div class="styles_main_container__pPP4G">
      ...
      <div class="styles_subscribe_container__yNwAU">
        ...
        <span class="styles_subheading__je0ZQ">Don’t miss out on the latest happenings at Cogoport.</span>
        <div class="styles_input_container__LNJZN">
          <form class="styles_border__7yY6A">
            <div>
              <input type="email" placeholder="Enter your email here" required="" value=""/>
            </div>
            <div>
              <button class="styles_button__wYa0P ui_nBRuU ui_button_container ui_ps_size_md ui_ps_themeType_primary" type="submit">Subscribe
