  ...
  return (
    <nav className="navbar navbar-expand-lg navbar-light" style={{ background: '#fbdc00' }}>
            ...
            <div className="collapse navbar-collapse" id="navbarNav">
                ...
                <ul class="navbar_box_1">
                    <li class="navbar_box_2" role="presentation" >
                    ...
                    <li class="navbar_register_button" role="presentation">
                    <button class="styles_register_signup__eTPFU ui_nBRuU ui_button_container ui_ps_size_md ui_ps_themeType_primary" type="button">
