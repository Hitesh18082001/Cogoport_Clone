...
const Demo= () => {
  return (
    <div className="demo_container">
        ...
        <div class="demo_image_nodisplay">
          <img alt="home page arrow" class="hidden_image_style" src="https://cdn.cogoport.io/cms-prod/cogo_public/vault/original/homepagem1.png"/>
        </div>

      <div className='demo_side_margin'>
        <div className="card top-left">
          <p style={{fontWeight: '800',color: '#ee3425'}}>Stage 1:</p>
          <div class="demo_heading_style">
          ...
          <span>
              <div>•</div>
              <p class="demo_para_style">Spot and Contract Rates for Logistics</p>
          </span>
          <span>
              <div>•</div>
              <p class="demo_para_style">Service details, Trade Compliance/ Regulatory Requirements</p>
          </span>
          <span>
              <div>•</div>
              <p class="demo_para_style">Knowledge and Insights on Trade, Logistics, Finance, Supply Chains</p>
          </span>
        </div>
        <div class="left_card_arrow left_card_position">
          <img alt="line for stages" loading="lazy" width="150" height="59" decoding="async" data-nimg="1" class="styles_arrowimage__50gz2" src="https://www.cogoport.com/_next/image?url=https%3A%2F%2Fcdn.cogoport.io%2Fcms-prod%2Fcogo_public%2Fvault%2Foriginal%2Flinearrow1.png&w=256&q=75" style={{color: 'transparent'}}/>
        </div>
        <div className="card bottom-left">
              <p style={{fontWeight: '800',color: '#ee3425'}}>Stage 2:</p>
              <div class="demo_heading_style">
              ...
              <span>
              <div>•</div>
              <p class="demo_para_style">Route, Service Schedules, Inventory, and Cashflow planning</p>
              </span>
              <span>
              <div>•</div>
              <p class="demo_para_style">Book with upfront visibility of service terms and inclusions</p>
              </span>
        </div>
        <div class="bottom_left_card_arrow bottom_left_card_position">
          <img alt="line for stages" loading="lazy" width="150" height="59" decoding="async" data-nimg="1" class="styles_arrowimage__50gz2" src="https://www.cogoport.com/_next/image?url=https%3A%2F%2Fcdn.cogoport.io%2Fcms-prod%2Fcogo_public%2Fvault%2Foriginal%2Flinearrow2.png&w=256&q=75" style={{color: 'transparent'}}/>
        </div> 
      </div>
     
   
        <div className='demo_image_container'>
          <img src="https://www.cogoport.com/_next/image?url=https%3A%2F%2Fcdn.cogoport.io%2Fcms-prod%2Fcogo_public%2Fvault%2Foriginal%2Fhomepagem1.png&w=640&q=75" alt="Your Image" className="centered-image" />
        </div>

      <div >        
        <div class="top_right_card_arrow top_right_card_position"><img alt="line for stages" loading="lazy" width="150" height="59" decoding="async" data-nimg="1" class="styles_arrowimage__50gz2" src='https://www.cogoport.com/_next/image?url=https%3A%2F%2Fcdn.cogoport.io%2Fcms-prod%2Fcogo_public%2Fvault%2Foriginal%2Flinearrow.png&w=256&q=75' style={{color: 'transparent'}}/>
        </div>
        <div className="card top-right">
        <p style={{fontWeight: '800',color: '#ee3425'}}>Stage 3:</p>
          <div class="demo_heading_style">
          ...
          <span>
          <div>•</div>
          <p class="demo_para_style">Ocean and Air Cargo Tracking</p>
          </span>
          <span>
          <div>•</div>
          <p class="demo_para_style">Documentation and Filings, Handled</p>
          </span>
          <span>
          <div>•</div>
          <p class="demo_para_style">Multi-modal: Smooth coordination and handovers between various service providers and stakeholders</p>
          </span>
        
        </div>
        <div class="bottom_right_card_arrow bottom_right_card_position"><img alt="home page arrow" loading="lazy" width="150" height="59" decoding="async" data-nimg="1" class="styles_arrowimage__50gz2" src="https://www.cogoport.com/_next/image?url=https%3A%2F%2Fcdn.cogoport.io%2Fcms-prod%2Fcogo_public%2Fvault%2Foriginal%2Flinearrow4.png&w=256&q=75" style={{color: 'transparent'}}/>
        </div>
        <div className="card bottom-right">
          <p style={{fontWeight: '800', color: '#ee3425'}}>Stage 4:</p>
          <div class="demo_heading_style">
          ...
          <span>
          <div>•</div>
          <p class="demo_para_style">Deferred payment on Logistics with PayLater</p>
          </span>
          <span>
          <div>•</div>
          <p class="demo_para_style">Trade Finance for your Cargo with Export Factoring</p>
          </span>
        </div>
       </div>
