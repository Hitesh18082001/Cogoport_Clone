...
export const Working = () => {
  return (
    <div class="styles_container__YcS5m ui_fixed_container ui_EvXjS">
        <div class="styles_main_container__ieOx_">
            <h3 class="styles_heading__j_j_U">How it Works</h3>
            <div class="styles_gtp_container_button__dy2Cq">
                <button class="styles_active__FEswy ui_nBRuU ui_button_container ui_ps_size_md ui_ps_themeType_primary" type="button">
                    <span class="ui_button_childeren">For Cargo Owners</span>
                </button>
                <button class="styles_inactive__Rq_Bh ui_nBRuU ui_button_container ui_ps_size_md ui_ps_themeType_primary" type="button">
                    <span class="ui_button_childeren">For Logistics Partners</span>
                </button>
            </div>
            <div>
                <div class="styles_container__7cFsf">
                    <div class="styles_imagecontainermobile__57eRt">
                        <img alt="home page arrow" class="styles_image__cFHAa" src="https://cdn.cogoport.io/cms-prod/cogo_public/vault/original/homepagem1.png"/>
                    </div>
                    <div>
                        <div class="styles_main__9QKz8 styles_stage1__RwgVC">
                            <p class="styles_redtext__qNc_O">Stage 1:</p>
                            <div class="styles_heading__GyQVu">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 14" width="40" height="40" role="img"><path class="ic-a-discover_svg__ic_a_discover" stroke="#221F1F" stroke-linecap="round" stroke-linejoin="round" stroke-width="0.264" d="M12.613 7h-1.576"></path><path class="ic-a-discover_svg__ic_a_discover" fill="#FBDC00" stroke="#221F1F" stroke-linecap="round" stroke-linejoin="round" stroke-width="0.264" d="M7 12.85a5.85 5.85 0 1 0 0-11.7 5.85 5.85 0 0 0 0 11.7Z"></path><path class="ic-a-discover_svg__ic_a_discover" fill="#fff" stroke="#221F1F" stroke-linecap="round" stroke-linejoin="round" stroke-width="0.264" d="M9.383 4.371 5.72 5.652a.11.11 0 0 0-.068.068L4.37 9.383a.21.21 0 0 0 .246.246L8.28 8.348a.109.109 0 0 0 .068-.068l1.28-3.663a.21.21 0 0 0-.245-.246Z"></path><path class="ic-a-discover_svg__ic_a_discover" fill="#221F1F" d="M7 7.762a.762.762 0 1 0 0-1.524.762.762 0 0 0 0 1.524Z"></path><path class="ic-a-discover_svg__ic_a_discover" stroke="#221F1F" stroke-linecap="round" stroke-linejoin="round" stroke-width="0.264" d="M7 1.387v1.576m0 9.65v-1.576M1.387 7h1.576"></path>
                                </svg>
                                <div>Discover</div>
                            </div>
                            <span>
                                <div>•</div>
                                <p class="styles_para__7I1R1">Spot and Contract Rates for Logistics</p>
                            </span>
                            <span>
                                <div>•</div>
                                <p class="styles_para__7I1R1">Service details, Trade Compliance/ Regulatory Requirements</p>
                            </span>
                            <span>
                                <div>•</div>
                                <p class="styles_para__7I1R1">Knowledge and Insights on Trade, Logistics, Finance, Supply Chains</p>
                            </span>
                        </div>
                        <div class="styles_arrow__JcExt styles_arrow1__hJg7v">
                        <img alt="line for stages" loading="lazy" width="150" height="59" decoding="async" data-nimg="1" class="styles_arrowimage__50gz2" srcset="/_next/image?url=https%3A%2F%2Fcdn.cogoport.io%2Fcms-prod%2Fcogo_public%2Fvault%2Foriginal%2Flinearrow1.png&amp;w=256&amp;q=75 1x, /_next/image?url=https%3A%2F%2Fcdn.cogoport.io%2Fcms-prod%2Fcogo_public%2Fvault%2Foriginal%2Flinearrow1.png&amp;w=384&amp;q=75 2x" src="https://www.cogoport.com/_next/image?url=https%3A%2F%2Fcdn.cogoport.io%2Fcms-prod%2Fcogo_public%2Fvault%2Foriginal%2Flinearrow1.png&w=256&q=75" style={{color: "transparent"}}/>
                        </div>
                        <div class="styles_main__9QKz8 styles_stage2__0Bmta">
                            <p class="styles_redtext__qNc_O">Stage 2:</p>
                            <div class="styles_heading__GyQVu">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 14" width="40" height="40" role="img"><path class="ic-a-plan_svg__ic_a_plan" fill="#FBDC00" stroke="#221F1F" stroke-linecap="round" stroke-linejoin="round" stroke-width="0.374" d="M9.37 1.851c0-.36-.276-.651-.617-.651-.34 0-.617.291-.617.651v1.307c0 .36.276.65.617.65.341.001.618-.29.618-.65V1.851Z"></path><g stroke="#221F1F" stroke-linecap="round" stroke-linejoin="round" stroke-width="0.374"><path class="ic-a-plan_svg__ic_a_plan" fill="#FBDC00" d="M9.935 2.2h-5.87c-.515 0-.932.44-.932.981v8.638c0 .542.417.981.932.981h5.87c.515 0 .932-.44.932-.981V3.18c0-.542-.417-.981-.932-.981Z"></path><path class="ic-a-plan_svg__ic_a_plan" fill="#FBDC00" d="M5.864 1.851c0-.36-.276-.651-.617-.651-.341 0-.618.291-.618.651v1.307c0 .36.277.65.618.65.34.001.617-.29.617-.65V1.851Z"></path><path class="ic-a-plan_svg__ic_a_plan" d="M6.366 5.78h2.908M6.366 8.095h2.908M6.366 10.41h2.908"></path><path class="ic-a-plan_svg__ic_a_plan" fill="#fff" d="M4.749 6.525c.39 0 .707-.334.707-.745s-.317-.745-.707-.745c-.39 0-.707.334-.707.745s.317.745.707.745Zm0 2.315c.39 0 .707-.334.707-.745s-.317-.745-.707-.745c-.39 0-.707.334-.707.745s.317.745.707.745Zm0 2.314c.39 0 .707-.333.707-.745 0-.411-.317-.744-.707-.744-.39 0-.707.333-.707.744 0 .412.317.745.707.745Z"></path></g>
                                </svg>
                                <div>Plan &amp; Book</div>
                            </div>
                            <span>
                            <div>•</div>
                            <p class="styles_para__7I1R1">Route, Service Schedules, Inventory, and Cashflow planning</p>
                            </span>
                            <span>
                            <div>•</div>
                            <p class="styles_para__7I1R1">Book with upfront visibility of service terms and inclusions</p>
                            </span>

                        </div>
                        <div class="styles_arrow__JcExt styles_arrow2__JOZhk">
                            <img alt="line for stages" loading="lazy" width="150" height="59" decoding="async" data-nimg="1" class="styles_arrowimage__50gz2" srcset="/_next/image?url=https%3A%2F%2Fcdn.cogoport.io%2Fcms-prod%2Fcogo_public%2Fvault%2Foriginal%2Flinearrow2.png&amp;w=256&amp;q=75 1x, /_next/image?url=https%3A%2F%2Fcdn.cogoport.io%2Fcms-prod%2Fcogo_public%2Fvault%2Foriginal%2Flinearrow2.png&amp;w=384&amp;q=75 2x" src="/_next/image?url=https%3A%2F%2Fcdn.cogoport.io%2Fcms-prod%2Fcogo_public%2Fvault%2Foriginal%2Flinearrow2.png&amp;w=384&amp;q=75" style={{color: "transparent"}}/>
                        </div>
                    </div>
                    <div class="styles_imagecontainer__7Ps6C">
                    <img alt="cogoport platform with rate search" loading="lazy" width="560" height="320" decoding="async" data-nimg="1" class="styles_image__cFHAa" srcset="/_next/image?url=https%3A%2F%2Fcdn.cogoport.io%2Fcms-prod%2Fcogo_public%2Fvault%2Foriginal%2Fhomepagem1.png&amp;w=640&amp;q=75 1x, /_next/image?url=https%3A%2F%2Fcdn.cogoport.io%2Fcms-prod%2Fcogo_public%2Fvault%2Foriginal%2Fhomepagem1.png&amp;w=1200&amp;q=75 2x" src="/_next/image?url=https%3A%2F%2Fcdn.cogoport.io%2Fcms-prod%2Fcogo_public%2Fvault%2Foriginal%2Fhomepagem1.png&amp;w=1200&amp;q=75" style={{color: "transparent"}}/>
                    </div>
                    <div>
            ...
            <div>
                ...
                <div class="styles_main__9QKz8">
                    ...
                    <span>
                    <div>•</div>
                    <p class="styles_para__7I1R1">Deferred payment on Logistics with PayLater</p>
                    </span>
                    <span>
                    <div>•</div>
                    <p class="styles_para__7I1R1">Trade Finance for your Cargo with Export Factoring</p>
                    </span>
                </div>
